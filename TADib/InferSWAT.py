...
from models.SCINetBiEvenSeqPretrainSWAT import SCIMaskEvenPretrain
...
def get_dtw(errors,labels, data_len, interval = 32):
    ...
    best_Threshold = Threshold[int(best_f1_final_index[0])]
...
if __name__ == "__main__":
    ...
    # chfdb_chf13_45590
    #
    data_dict = load_dataset(args.dataset, subdataset='swat', use_dim="all", root_dir="/", nrows=None)
    ...
    dir_path = 'SWAT_Results'


    model_load_path = f'{dir_path}/{args.variate_index}dim/' \
...
#################################################################################################
    ...
    if find_threshold:
        ...
        # InitF1 score: 0.7995211492418196, Threshods: 4.2533883655844305
        # SeqF1 score: 0.9094418436296912
        # Seq precision: 0.8504406768129619
        # Seq recall: 0.9772514786892311          # is adjusted results
    ...
    print(f'Adjusted F1 score: {f1}')                         # related to adjust,  mei ban fan jia ab,
